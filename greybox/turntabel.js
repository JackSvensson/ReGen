class ToyViewer {
  constructor(containerId, imageId, isDesktop = false) {
    ...
    this.images = {
      red: Array.from(
        { length: 12 },
        (_, i) => `/assets/Nalle_Turntable_Brun(${i + 1}).png`
      ),
      blue: Array.from(
        { length: 12 },
        (_, i) => `/assets/Nalle_Turntable_Bla(${i + 1}).png`
      ),
      green: Array.from(
        { length: 12 },
        (_, i) => `/assets/Nalle_Turntable_Gul(${i + 1}).png`
      ),
      yellow: Array.from(
        { length: 12 },
        (_, i) => `/assets/Nalle_Turntable_Rosa(${i + 1}).png`
      ),
    };
